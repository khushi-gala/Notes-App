...
const SearchBar = ({value, onChange, handleSearch, onClearSearch }) => {
  ...
  <input
    ...
    className='w-full text-xs sm:text-sm bg-transparent py-[11px] sm:px-3 sm:py-[11px] outline-none dark:text-zinc-400 placeholder:text-neutral-800 dark:placeholder:text-zinc-400'
    value={value}
    onChange={onChange}
  ...
  {value && (
    <IoMdClose 
      className="text-xl sm:text-xl dark:text-zinc-400 cursor-pointer dark:hover:text-gray-200 mr-3 hover:hover:scale-125 transition-all ease-in-out" 
