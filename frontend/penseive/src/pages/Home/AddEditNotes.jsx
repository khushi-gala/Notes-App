...
const AddEditNotes = ({noteData, type, getAllNotes, onClose, showToastMessage}) => {
  ...
  return (
    <div className='relative p-3 overs'>
        ...
        <div className='flex flex-col gap-2 mt-4'>
            ...
            /> */}
            <div id="editor" className="text-sm text-neutral-900 bg-zinc-200 rounded p-2 dark:bg-neutral-900  dark:text-zinc-300" 
        ...
        <button className='btn-primary bg-cpurple text-zinc-200 text-lg dark:bg-blue-900 font-medium mt-5 p-3 sm:p-3 md:p-4 hover:scale-95 transition-all ease-in-out dark:text-zinc-300 dark:hover:text-zinc-200' 
